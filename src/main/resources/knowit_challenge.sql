...
--
-- TOC entry 2978 (class 1262 OID 204654)
-- Name: knowit_challenge; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE knowit_challenge WITH TEMPLATE = template0 ENCODING = 'UTF8';


\connect knowit_challenge
